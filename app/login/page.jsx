    ...
    await authClient.signIn.email(
      {
        email,
        password,
        callbackURL: '/my-profile', // Corrected route path to match your folder tree!
      },
      {
        onRequest: () => {
        ...
        onError: (ctx) => {
          // Captures real engine errors (like wrong password) cleanly
  ...
  return (
    <div className="pt-20">
      <div className="border p-8 w-fit py-5 rounded-2xl my-20 mx-auto bg-base-100 shadow-md">
        ...
        <div className="border-t border-base-content/10 mt-6 text-center pt-5">
          <Button 
            onClick={handleGoogleSignIn} 
            className="w-full btn btn-outline flex items-center justify-center gap-2"
          >
            {/* Inline Google Colored SVG Icon wrapper */}
